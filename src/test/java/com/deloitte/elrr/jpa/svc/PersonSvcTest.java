...
public class PersonSvcTest {
    ...
    void findPersonsWithFiltersTest() {
        Mockito.doReturn(getTestPeople()).when(personRepository)
                .findPersonsWithFilters(Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any());
        Iterable<Person> people = personSvc.findPersonsWithFilters(null, null, null, null, null, null, null, null);
        assertEquals(Iterables.size(people), 1);
    }
